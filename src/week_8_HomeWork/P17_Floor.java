 ...
 */
    ...
    //Create 2nd class Carpet
    class Carpet {

        double cost;  //global variable
    ...
    class Calculator {
        ...
        //Create Instance method with return type
    ...
    class Main {
        ...
        public static void main(String[] args) {
            ...
            Carpet carpet = new Carpet(3.5); //Create object //Constructor
            P17_Floor floor = new P17_Floor(2.75, 4.0);
            Calculator calculator = new Calculator(floor, carpet);
            System.out.println("total= " + calculator.getTotalCost()); //Call getTotalCost method in main method
            carpet = new Carpet(1.5);
            floor = new P17_Floor(5.4, 4.5);
            calculator = new Calculator(floor, carpet); //call constructor by creating object
            System.out.println("total= " + calculator.getTotalCost()); //call method
